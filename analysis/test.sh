...
singularity exec --cleanenv \
  ...
  --pwd "${PROJECT_PATH}" \
  "$SIF" \
  Rscript --vanilla "${PROJECT_PATH}/analysis/vignette_script_walkthrough_CPAM_Models.R"
...
singularity exec --cleanenv \
  ...
  --pwd "${PROJECT_PATH}" \
  "$SIF" \
  Rscript --vanilla "${PROJECT_PATH}/analysis/vignette_script_walkthrough_CPAM_All_Models_Together_Tissues.R"
...
singularity exec --cleanenv \
  ...
  --pwd "${PROJECT_PATH}" \
  "$SIF" \
  Rscript --vanilla "${PROJECT_PATH}/analysis/vignette_script_walkthrough_CPAM_Mouse.R"
